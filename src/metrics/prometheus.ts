// ---------------------------------------------------------------------------
// bunpm – Prometheus Exposition Format
// ---------------------------------------------------------------------------
...
const PER_APP_METRICS: MetricDescriptor[] = [
  {
    name: 'bunpm_app_workers_online',
    help: 'Number of workers in online state',
    type: 'gauge',
  },
  {
    name: 'bunpm_app_workers_errored',
...
const MASTER_METRICS: MetricDescriptor[] = [
  {
    name: 'bunpm_master_uptime_seconds',
    help: 'Uptime of the bunpm master process in seconds',
    type: 'gauge',
  },
];
...
function appMetricValue(metricName: string, app: AppMetricsInput): number {
  switch (metricName) {
    case 'bunpm_app_workers_online':
      return app.workers.filter((w) => w.state === 'online').length;

    case 'bunpm_app_workers_errored':
